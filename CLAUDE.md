...
- `cd backend && cargo test` — Run tests (270 tests)
...
│       ├── logic/               # Data sync + 10 agronomic rules + GDD accumulation + seasonal plan + disease risk models + seeding/pre-emergent timing windows + inventory.rs (shelf enrichment pass)
