	...
	return (
		<div>
			...
			<div style={styles.filterRow}>
				<span style={styles.filterLabel}>Scope:</span>
				...
				<label
					htmlFor="type-filter"
					style={{ ...styles.filterLabel, marginLeft: 16 }}
				>
					Type:
				</label>
				<select
					...
					<tbody>
						{visibleApps.map((app, index) => (
							<tr key={app.id ?? `app-${index}`}>
								...
								<td style={sharedStyles.td}>
									{app.plant_id != null ? (
										(plantNameById.get(app.plant_id) ??
										`Plant #${app.plant_id}`)
									) : (
								...
								<td style={sharedStyles.td}>{app.follow_up_date ?? "-"}</td>
	...
	return (
		<form onSubmit={handleSubmit} style={styles.form}>
			<div style={styles.formGrid}>
				<div>
					<label htmlFor="app-type" style={styles.formLabel}>
						Type
					</label>
					<select
						id="app-type"
				...
				{plantSelectable && (
					<div>
						<label htmlFor="app-plant" style={styles.formLabel}>
				...
				<div>
					<label htmlFor="app-date" style={styles.formLabel}>
						Date
					</label>
					<input
						id="app-date"
				...
				<div>
					<label htmlFor="app-coverage" style={styles.formLabel}>
						Coverage (sqft)
					</label>
					<input
						id="app-coverage"
				...
				<div>
					<label htmlFor="app-notes" style={styles.formLabel}>
						Notes
					</label>
					<input
						id="app-notes"
				...
				<div>
					<label htmlFor="app-nitrogen-pct" style={styles.formLabel}>
						N %
					</label>
					<input
						id="app-nitrogen-pct"
				...
				<div>
					<label htmlFor="app-phosphorus-pct" style={styles.formLabel}>
						P %
					</label>
					<input
						id="app-phosphorus-pct"
						type="number"
						step="0.1"
						style={styles.input}
						value={phosphorusPct}
				...
				<div>
					<label htmlFor="app-potassium-pct" style={styles.formLabel}>
						K %
					</label>
					<input
						id="app-potassium-pct"
						type="number"
						step="0.1"
						style={styles.input}
						value={potassiumPct}
