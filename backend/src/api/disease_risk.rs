...
use crate::models::{DailyWeather, DiseaseRiskResponse};
...
/// Per-disease risk from published/heuristic weather models: observed days come from
/// the data lake's hourly silver layer, today's remainder and the outlook from the
/// OpenWeatherMap forecast, and lawn history (overseeding, nitrogen) amplifies where
/// the science says it should.
